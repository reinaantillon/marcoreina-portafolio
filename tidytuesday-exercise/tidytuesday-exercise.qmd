...
### It seems like lm is not a good approach for this dataset, it seems there is something underlaying with the data that I am not able to determine why the prediction power of the lm is just not working. I am going to try to fit a Rand_forest
